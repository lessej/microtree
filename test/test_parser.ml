...
let chars_of_str_suite =
  ...
  >::: [ "basic" >:: test_chars_of_str; "empty" >:: test_chars_of_empty_str ]
...
let test_split_level _ =
  let test_trees tree expected =
    ...
    assert_equal res expected
  in
  test_trees "root (level1_1, level1_2 (level2_1, level2_2))"
    [ "root (level1_1, level1_2 (level2_1, level2_2))" ];
  test_trees "root_1, root_2" [ "root_1"; "root_2" ]

let split_on_level_suite =
  "MicrotreeTest split_on_level" >::: [ "basic" >:: test_split_level ]
...
let into_tree_parts_suite =
  "MicrotreeTest into_tree_parts" >::: [ "basic" >:: test_into_tree_parts ]
